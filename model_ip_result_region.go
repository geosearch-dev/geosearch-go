...
// checks if the IPResultRegion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IPResultRegion{}

// IPResultRegion struct for IPResultRegion
type IPResultRegion struct {
	IsoCode *string `json:"iso_code,omitempty"`
	Name *string `json:"name,omitempty"`
}

// NewIPResultRegion instantiates a new IPResultRegion object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewIPResultRegion() *IPResultRegion {
	this := IPResultRegion{}
	return &this
}

// NewIPResultRegionWithDefaults instantiates a new IPResultRegion object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewIPResultRegionWithDefaults() *IPResultRegion {
	this := IPResultRegion{}
	return &this
}

// GetIsoCode returns the IsoCode field value if set, zero value otherwise.
func (o *IPResultRegion) GetIsoCode() string {
...
func (o *IPResultRegion) GetIsoCodeOk() (*string, bool) {
	if o == nil || IsNil(o.IsoCode) {
		return nil, false
	}
...
func (o *IPResultRegion) HasIsoCode() bool {
	if o != nil && !IsNil(o.IsoCode) {
		return true
	}
...
func (o *IPResultRegion) SetIsoCode(v string) {
	o.IsoCode = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *IPResultRegion) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *IPResultRegion) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *IPResultRegion) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *IPResultRegion) SetName(v string) {
	o.Name = &v
}

func (o IPResultRegion) MarshalJSON() ([]byte, error) {
...
func (o IPResultRegion) ToMap() (map[string]interface{}, error) {
...
type NullableIPResultRegion struct {
	value *IPResultRegion
	isSet bool
}

func (v NullableIPResultRegion) Get() *IPResultRegion {
	return v.value
}

func (v *NullableIPResultRegion) Set(val *IPResultRegion) {
	v.value = val
	v.isSet = true
}

func (v NullableIPResultRegion) IsSet() bool {
	return v.isSet
}

func (v *NullableIPResultRegion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIPResultRegion(val *IPResultRegion) *NullableIPResultRegion {
	return &NullableIPResultRegion{value: val, isSet: true}
}

func (v NullableIPResultRegion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIPResultRegion) UnmarshalJSON(src []byte) error {
	v.isSet = true
