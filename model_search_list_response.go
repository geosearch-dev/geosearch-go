...
// checks if the SearchListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchListResponse{}

// SearchListResponse struct for SearchListResponse
...
// SetData gets a reference to the given []SearchResult and assigns it to the Data field.
...
func (o SearchListResponse) MarshalJSON() ([]byte, error) {
...
func (o SearchListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSearchListResponse struct {
	value *SearchListResponse
	isSet bool
}

func (v NullableSearchListResponse) Get() *SearchListResponse {
	return v.value
}

func (v *NullableSearchListResponse) Set(val *SearchListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchListResponse(val *SearchListResponse) *NullableSearchListResponse {
	return &NullableSearchListResponse{value: val, isSet: true}
}

func (v NullableSearchListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
