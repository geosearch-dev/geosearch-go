...
**AdminName3** | Pointer to **string** | Third-level administrative area. Empty where the source data defines none — most US rows, including this example. | [optional] 
**AdminCode3** | Pointer to **string** | Third-level administrative code. Empty where the source data defines none — most US rows, including this example. | [optional] 
