...
// checks if the AutocompleteListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutocompleteListResponse{}

// AutocompleteListResponse struct for AutocompleteListResponse
type AutocompleteListResponse struct {
	Data []AutocompleteResult `json:"data,omitempty"`
...
// SetData gets a reference to the given []AutocompleteResult and assigns it to the Data field.
...
func (o AutocompleteListResponse) MarshalJSON() ([]byte, error) {
...
func (o AutocompleteListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableAutocompleteListResponse struct {
	value *AutocompleteListResponse
	isSet bool
}

func (v NullableAutocompleteListResponse) Get() *AutocompleteListResponse {
	return v.value
}

func (v *NullableAutocompleteListResponse) Set(val *AutocompleteListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAutocompleteListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAutocompleteListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutocompleteListResponse(val *AutocompleteListResponse) *NullableAutocompleteListResponse {
	return &NullableAutocompleteListResponse{value: val, isSet: true}
}

func (v NullableAutocompleteListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutocompleteListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
