...
// checks if the TimezoneSingleResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimezoneSingleResponse{}

// TimezoneSingleResponse struct for TimezoneSingleResponse
type TimezoneSingleResponse struct {
	Data *Timezone `json:"data,omitempty"`
}

// NewTimezoneSingleResponse instantiates a new TimezoneSingleResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTimezoneSingleResponse() *TimezoneSingleResponse {
	this := TimezoneSingleResponse{}
	return &this
}

// NewTimezoneSingleResponseWithDefaults instantiates a new TimezoneSingleResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTimezoneSingleResponseWithDefaults() *TimezoneSingleResponse {
	this := TimezoneSingleResponse{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *TimezoneSingleResponse) GetData() Timezone {
...
func (o *TimezoneSingleResponse) GetDataOk() (*Timezone, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *TimezoneSingleResponse) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// SetData gets a reference to the given Timezone and assigns it to the Data field.
func (o *TimezoneSingleResponse) SetData(v Timezone) {
	o.Data = &v
}

func (o TimezoneSingleResponse) MarshalJSON() ([]byte, error) {
...
func (o TimezoneSingleResponse) ToMap() (map[string]interface{}, error) {
...
type NullableTimezoneSingleResponse struct {
	value *TimezoneSingleResponse
	isSet bool
}

func (v NullableTimezoneSingleResponse) Get() *TimezoneSingleResponse {
	return v.value
}

func (v *NullableTimezoneSingleResponse) Set(val *TimezoneSingleResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTimezoneSingleResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTimezoneSingleResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimezoneSingleResponse(val *TimezoneSingleResponse) *NullableTimezoneSingleResponse {
	return &NullableTimezoneSingleResponse{value: val, isSet: true}
}

func (v NullableTimezoneSingleResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimezoneSingleResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
