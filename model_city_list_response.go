...
// checks if the CityListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CityListResponse{}

// CityListResponse struct for CityListResponse
...
func (o CityListResponse) MarshalJSON() ([]byte, error) {
...
func (o CityListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCityListResponse struct {
	value *CityListResponse
	isSet bool
}

func (v NullableCityListResponse) Get() *CityListResponse {
	return v.value
}

func (v *NullableCityListResponse) Set(val *CityListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCityListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCityListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCityListResponse(val *CityListResponse) *NullableCityListResponse {
	return &NullableCityListResponse{value: val, isSet: true}
}

func (v NullableCityListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCityListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
