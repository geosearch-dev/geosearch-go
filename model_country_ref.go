...
// checks if the CountryRef type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CountryRef{}

// CountryRef struct for CountryRef
type CountryRef struct {
	IsoCode *string `json:"iso_code,omitempty"`
	Name *string `json:"name,omitempty"`
}

// NewCountryRef instantiates a new CountryRef object
...
// NewCountryRefWithDefaults instantiates a new CountryRef object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCountryRefWithDefaults() *CountryRef {
	this := CountryRef{}
	return &this
}

// GetIsoCode returns the IsoCode field value if set, zero value otherwise.
func (o *CountryRef) GetIsoCode() string {
...
func (o *CountryRef) GetIsoCodeOk() (*string, bool) {
	if o == nil || IsNil(o.IsoCode) {
		return nil, false
	}
...
func (o *CountryRef) HasIsoCode() bool {
	if o != nil && !IsNil(o.IsoCode) {
		return true
	}
...
func (o *CountryRef) SetIsoCode(v string) {
	o.IsoCode = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *CountryRef) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *CountryRef) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *CountryRef) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *CountryRef) SetName(v string) {
	o.Name = &v
}

func (o CountryRef) MarshalJSON() ([]byte, error) {
...
func (o CountryRef) ToMap() (map[string]interface{}, error) {
...
type NullableCountryRef struct {
	value *CountryRef
	isSet bool
}

func (v NullableCountryRef) Get() *CountryRef {
	return v.value
}

func (v *NullableCountryRef) Set(val *CountryRef) {
	v.value = val
	v.isSet = true
}

func (v NullableCountryRef) IsSet() bool {
	return v.isSet
}

func (v *NullableCountryRef) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCountryRef(val *CountryRef) *NullableCountryRef {
	return &NullableCountryRef{value: val, isSet: true}
}

func (v NullableCountryRef) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCountryRef) UnmarshalJSON(src []byte) error {
	v.isSet = true
