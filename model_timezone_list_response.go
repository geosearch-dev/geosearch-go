...
// checks if the TimezoneListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimezoneListResponse{}

// TimezoneListResponse struct for TimezoneListResponse
...
func (o TimezoneListResponse) MarshalJSON() ([]byte, error) {
...
func (o TimezoneListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableTimezoneListResponse struct {
	value *TimezoneListResponse
	isSet bool
}

func (v NullableTimezoneListResponse) Get() *TimezoneListResponse {
	return v.value
}

func (v *NullableTimezoneListResponse) Set(val *TimezoneListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTimezoneListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTimezoneListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimezoneListResponse(val *TimezoneListResponse) *NullableTimezoneListResponse {
	return &NullableTimezoneListResponse{value: val, isSet: true}
}

func (v NullableTimezoneListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimezoneListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
